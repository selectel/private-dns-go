...
const (
	...
	apiServicesListJSON  = `{"services":[{"id":"test_service","project":"test_project","network_id":"test_network","high_availability":true,"is_recursor_enabled":true}]}`
	apiServiceDetailJSON = `{"service":{"id":"test_service","project":"test_project","network_id":"test_network","high_availability":true,"is_recursor_enabled":true, "addresses": [{"cidr": "192.168.0.0/24", "address": "192.168.0.1"}]}}`
